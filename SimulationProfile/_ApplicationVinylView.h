...
#ifndef _ApplicationVinylView_H
#define _ApplicationVinylView_H
...
/* Forward declaration of the class Application::VinylView */
#ifndef _ApplicationVinylView_
  EW_DECLARE_CLASS( ApplicationVinylView )
#define _ApplicationVinylView_
#endif
...
/* Deklaration of class : 'Application::VinylView' */
EW_DEFINE_FIELDS( ApplicationVinylView, CoreGroup )
  EW_OBJECT  ( Vinyl,           ViewsWarpImage )
  EW_OBJECT  ( AngleEffect,     EffectsFloatEffect )
  EW_PROPERTY( Angle,           XFloat )
EW_END_OF_FIELDS( ApplicationVinylView )

/* Virtual Method Table (VMT) for the class : 'Application::VinylView' */
EW_DEFINE_METHODS( ApplicationVinylView, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationVinylView )
