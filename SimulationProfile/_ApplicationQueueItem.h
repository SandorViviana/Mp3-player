...
#ifndef _ApplicationQueueItem_H
#define _ApplicationQueueItem_H
...
/* Forward declaration of the class Application::QueueItem */
#ifndef _ApplicationQueueItem_
  EW_DECLARE_CLASS( ApplicationQueueItem )
#define _ApplicationQueueItem_
#endif
...
/* Deklaration of class : 'Application::QueueItem' */
EW_DEFINE_FIELDS( ApplicationQueueItem, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Title,           ViewsText )
  EW_OBJECT  ( Artist,          ViewsText )
  EW_PROPERTY( Source,          XString )
EW_END_OF_FIELDS( ApplicationQueueItem )

/* Virtual Method Table (VMT) for the class : 'Application::QueueItem' */
EW_DEFINE_METHODS( ApplicationQueueItem, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ApplicationQueueItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationQueueItem )
