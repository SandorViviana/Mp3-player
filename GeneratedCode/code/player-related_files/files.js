...
list=new Array(
        ...
        "./media/Camille_Saint-Saens_-_introduction_et_rondo_capriccioso,_op._28.mp3",
        "./media/Clair_de_lune_(Claude_Debussy)_Suite_bergamasque.mp3",
        "./media/Bartok_Op._17,_Second_Movement.mp3",
        "./media/Modest_Mussorgsky_-_night_on_bald_mountain.mp3",       
        "./media/Dvorak_String_Serenade_II_Tempo_di_Valse.mp3",
        "./media/Stravinsky_Infernal_Dance_of_Kastchei.mp3",       
        "./media/Smetana,_Má_vlast_-_Vltava_-_The_Moldau.mp3",
        "./media/Stereohada - The Call.mp3"
    )
var SongList={
