...
var Dm=[0,0,0,0];var Ec="No graphics engine bitmap attached to this canvas";var EZ=
"The canvas is already initialized with a graphics engine bitmap";var Gc="WarpBitmap() operation has been omitted due to the resulting area "+
"being wider or higher than 4069 pixel.";var Gd="ScaleBitmap() operation has been omitted due to the resulting area "+
"being wider or higher than 4069 pixel.";
C.Canvas={AL:null,Hu:B.vx,D9:0,Ia:false,Dt:function(){if(this.Ia)this.DetachBitmap(
);},Ci:function(aArg){this.Fn=true;},MJ:function(value){if((value[0]<=0)||(value[
1]<=0))value=Aw;if(B.z8(value,this.FrameSize))return;if(this.Ia)throw new Error(
Bk);this.FrameSize=value;this.CE=(((this.FrameSize[0]>0)&&(this.FrameSize[1]>0))&&(
...
Aw;this.FrameDelay=0;this.NoOfFrames=1;}this.Hu=[].concat(Aw,this.FrameSize);if(
!!this.bitmap){var dstFrameNr=this.D9;for(this.D9=this.NoOfFrames-1;this.D9>=0;this.
D9--)this.Kf(this.Hu,this.Hu,0x00000000,0x00000000,0x00000000,0x00000000,false);
this.D9=dstFrameNr;}}if(!(((A=this.Hu)[0]>=A[2])||(A[1]>=A[3])))this.Hu=Dm;},DetachBitmap:
function(){if(!this.Ia)throw new Error(Ec);this.bitmap=null;this.Ia=false;this.FrameSize=
Aw;this.FrameDelay=0;this.NoOfFrames=1;this.CE=false;return this;},AttachBitmap:
...
this.CE=(this.FrameDelay>0)&&(this.NoOfFrames>1);return this;},Mn:function(aClip
...
,aDstRect,GZ,aColorTL,aColorTR,aColorBR,aColorBL,aBlend){var A;if(!this.bitmap)this.
Update();if(!this.bitmap)return;if((((!aBitmap||!aBitmap.bitmap)||!GZ)||(aFrameNr<
...
);var left=((GZ&0x1)===0x1);var top=((GZ&0x2)===0x2);var right=((GZ&0x4)===0x4);
var bottom=((GZ&0x8)===0x8);var interior=((GZ&0x10)===0x10);{B.zp(dstBitmap,srcBitmap
...
"%s",Gc);return;}var dstBitmap=this.bitmap;var srcBitmap=aBitmap.bitmap;var dstFrameNr=
...
4096))||((bottom-top)>4096))||((bottom-top)<-4096)){B.aa8("%s",Gd);return;}var dstBitmap=
...
Canvas;this.Ci(aArg);},_Done:function(){this.Dt();this.__proto__=B.abg.V;B.abg.V.
...
};C.Hl={Left:0x1,P6:0x2,Right:0x4,Oe:0x8,RY:0x10};
C._Init=function(){C.Canvas.__proto__=B.abg.V;};C._ReInit=function(){};C.CK=function(
D){};return C;})();
